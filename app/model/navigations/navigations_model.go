...
// arModel is a active record design model for table rotab_navigations operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_navigations.
	Table = "rotab_navigations"
	// Model is the model object of rotab_navigations.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_navigations.
	Columns = struct {
		Id          string //   
        CreatedAt   string //   
        UpdatedAt   string //   
