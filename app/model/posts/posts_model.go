...
// arModel is a active record design model for table rotab_posts operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_posts.
	Table = "rotab_posts"
	// Model is the model object of rotab_posts.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_posts.
	Columns = struct {
		Id            string //   
        CreatedAt     string //   
        UpdatedAt     string //   
