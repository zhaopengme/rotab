...
// arModel is a active record design model for table rotab_userinfo operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_userinfo.
	Table = "rotab_userinfo"
	// Model is the model object of rotab_userinfo.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_userinfo.
	Columns = struct {
		Id           string //   
        CreatedAt    string //   
        UpdatedAt    string //   
