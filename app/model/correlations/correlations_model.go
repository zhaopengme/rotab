...
// arModel is a active record design model for table rotab_correlations operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_correlations.
	Table = "rotab_correlations"
	// Model is the model object of rotab_correlations.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_correlations.
	Columns = struct {
		Id         string //   
        CreatedAt  string //   
        UpdatedAt  string //   
