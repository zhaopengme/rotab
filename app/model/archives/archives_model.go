...
// arModel is a active record design model for table rotab_archives operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_archives.
	Table = "rotab_archives"
	// Model is the model object of rotab_archives.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_archives.
	Columns = struct {
		Id            string //   
        CreatedAt     string //   
        UpdatedAt     string //   
