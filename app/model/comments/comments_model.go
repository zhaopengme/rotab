...
// arModel is a active record design model for table rotab_comments operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_comments.
	Table = "rotab_comments"
	// Model is the model object of rotab_comments.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_comments.
	Columns = struct {
		Id               string //   
        CreatedAt        string //   
        UpdatedAt        string //   
