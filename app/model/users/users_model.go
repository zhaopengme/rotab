...
// arModel is a active record design model for table rotab_users operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_users.
	Table = "rotab_users"
	// Model is the model object of rotab_users.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_users.
	Columns = struct {
		Id         string //   
        CreatedAt  string //   
        UpdatedAt  string //   
