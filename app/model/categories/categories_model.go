...
// arModel is a active record design model for table rotab_categories operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_categories.
	Table = "rotab_categories"
	// Model is the model object of rotab_categories.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_categories.
	Columns = struct {
		Id           string //   
        CreatedAt    string //   
        UpdatedAt    string //   
