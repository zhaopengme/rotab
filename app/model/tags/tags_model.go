...
// arModel is a active record design model for table rotab_tags operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_tags.
	Table = "rotab_tags"
	// Model is the model object of rotab_tags.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_tags.
	Columns = struct {
		Id            string //   
        CreatedAt     string //   
        UpdatedAt     string //   
