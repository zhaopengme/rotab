...
// arModel is a active record design model for table rotab_options operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rotab_options.
	Table = "rotab_options"
	// Model is the model object of rotab_options.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rotab_options.
	Columns = struct {
		Id         string //   
        CreatedAt  string //   
        UpdatedAt  string //   
